...
import { Button, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, FormControl, FormLabel, Select, Textarea, useDisclosure, useToast } from "@chakra-ui/react"
                        ...
                        <div className="verification">
                            <div className="verificationFlex">
                                ...
                                <div className="numberVerify">
                                    ...
                                    <button className="numberVerifyBtn" onClick={() =>
                                        toast({
                            ...
                            <div className="ImportingDiv">
                                {
                                    data.map((el) => {
                                        ...
                                        return <SingleProduct key={el.id} prdctImg={el.image} Name={el.title} price={el.rental} deposite={el.deposit} />
                                    })
                                }
                            </div>
                        </div>
