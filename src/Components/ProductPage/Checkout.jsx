  ...
  return (
    <Box>
      ...
      <Flex>
        <Box w="80%" >
            <Box h="800px">
                  <Image w="100%" objectFit="cover"  h="100%" src={item.image}></Image>
            </Box>
            <Flex>
              <Button w="50%" p="3%" fontSize="xl">Why rent from us?</Button>
              <Button w="50%" bg="white" p="3%" fontSize="xl">Product Details</Button>
            </Flex>
            <Box p="7%" boxShadow="rgba(0, 0, 0, 0.35) 0px 5px 15px;">
              <Text fontSize="3xl" fontWeight="bold">Product Details</Text>
              <Flex mt="1.5rem" gap="5%">
                ...
                <Box>
                  ...
                  <Flex mt="1.5rem" gap="5%">
                    <Box w="46%">
                      <Text fontSize="lg" fontWeight="bold">Dimensions</Text>
                       <UnorderedList>
                      <ListItem>{item.dimensions}</ListItem>
                      </UnorderedList>
                      <Text fontSize="lg" fontWeight="bold" mt="1.5rem">Material & Color</Text>
                      <Text>{item.color}</Text>
                    </Box>
                    <Box w="46%">
                       <Text fontSize="lg" fontWeight="bold">Features & Specs</Text>
                  ...
                  <Flex mt="1.5rem" gap="8%">
                    <Flex w="45%">
                      <Text fontSize="lg" fontWeight="bold" >Monthly Rental:</Text>
        ...
        >
          {sliderValue}
            ...
            <Box mt="3rem">
              <Flex>
                <Box w="50%" p="5%" pt="8%" pb="8%" border="1px solid #e6e6e6">
              ...
              <Flex  border="1px solid #e6e6e6" p="8%">
                ...
                <Text fontSize="sm" color="skyblue">View All</Text>
                
                
              </Flex>
            </Box>
            <Button border="1px solid #1dbdc0" w="100%" mt="1.5rem" p="8%" bg="none" fontSize="lg" color="#1dbdc0">Compare All Tenures</Button>
            {toggle? <Button bg="#DC3226" mt="2rem" onClick={Carthandler} w="100%" fontSize="xl" color="white" p="10%" gap="10px"><GrCart  />
              Book Your Plan
            </Button>:
            <Flex gap="5%">
              <Button bg="none" border="1px solid #DC3226" mt="2rem" fontSize="lg" color="#DC3226" p="8%"  w="45%"><Link to={`/${city}/Furniture`}>Browse More</Link></Button>
              <Button bg="#DC3226" mt="2rem"  fontSize="md" color="white" p="8%" gap="5px"  w="45%"><Link to={`/${city}/Packages`}><Flex><GrCart />View Cart</Flex></Link></Button>
            </Flex>}
